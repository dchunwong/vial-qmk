...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
        ...
        KC_LCTL,KC_LGUI,KC_LALT,                KC_SPC,                 KC_RALT,TG(1),MO(2),       KC_LEFT,KC_DOWN,KC_RGHT
    ),
  [1] = LAYOUT(
        ...
        KC_CAPS,KC_LALT,KC_LGUI,                _______,                KC_LGUI,_______,_______,     _______,_______,_______
    ),
  [2] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______,_______,KC_END, KC_PGDN,_______,_______,     KC_MUTE,
        _______,_______,_______,                _______,                _______,LALT(KC_GRAVE),_______,     KC_MPLY,KC_MPRV,KC_MNXT
    ),
  [3] = LAYOUT(
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,     _______,
        _______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,     _______,
